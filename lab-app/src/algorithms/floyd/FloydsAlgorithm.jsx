    ...
    <div style={{ display: 'flex', marginTop: '20px' }}>
        ...
        <main style={{ flexGrow: 1 }}>
            ...
            <div style={{
                ...
                <section id="aim">
                    <h2>Aim</h2>
                    <p>The aim of this page is to provide a comprehensive understanding of the Floyd's algorithm, its implementation, and applications.</p>
                </section>
                ...
                <section id="recap">
                    <h2>Recap</h2>
                    <p>In previous lessons, we covered weighted graphs and their applications in detail. This algorithm is a simple yet powerful algoritm to determine the shortest paths between two vertices of a graph.</p>
                </section>
